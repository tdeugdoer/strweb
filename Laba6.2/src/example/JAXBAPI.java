...
import example.xmlmarshlling.PersonXML;
import example.xmlmarshlling.QueryType;
...
public class JAXBAPI {
    ...
    public static PersonEntity executeXML(String filename, Session session, QueryType type) throws IOException, JAXBException {
