...
import example.command.RegisterPageCommand;
import example.command.authorithation.LoginCommand;
import example.command.authorithation.RegisterNewUserCommand;
import example.command.authorithation.SignOutCommand;
import example.command.grouppersons.AddNewPersonCommand;
import example.command.grouppersons.WelcomeCommand;
import example.command.Command;
import example.command.LoginPageCommand;
